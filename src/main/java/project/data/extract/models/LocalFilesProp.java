...
public class LocalFilesProp {
    private String root_dir, getInsert_scripts_dir ,appl_dir;
    private String extracted_details_file, insert_queries_file, select_queries_file, insert_scripts_dir;
